...
<link rel="stylesheet" href="/Public/Admin/ue/themes/default/css/umeditor.css" />
...
<div class="main">
    ...
    <p class="short-input ue-clear">
    	<label>内容：
			<script name="content" type="text/plain" id="myEditor" style="width:1000px;height:240px;"></script>
    	</label>
    </p>
</div>
