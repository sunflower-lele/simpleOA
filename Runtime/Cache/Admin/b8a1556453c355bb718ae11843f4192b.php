...
<div class="main">
	...
	<p class="short-input ue-clear">
    	<label>附件：</label>
        <input name="file" type="file"/>注：空则表示不修改
    </p>
    <p class="short-input ue-clear">
    	<label>作者：</label>
    ...
    <p class="short-input ue-clear">
    	<label>内容：<script name="content" type="text/plain" id="myEditor" style="width:1000px;height:240px;"><?php echo (htmlspecialchars_decode($data["content"])); ?>
		</script>
		</label>
    </p>
</div>
