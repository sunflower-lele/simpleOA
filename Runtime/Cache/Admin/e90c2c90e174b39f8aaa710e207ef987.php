...
<div id="container">
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="toolbar ue-clear"> <a href="javascript:;" date=src="home.html" class="home-btn">首页</a> <a href="javascript:;" class="quit-btn exit"></a> </div>
    </div>
  </div>
  <div id="bd">
        ...
        <ul class="nav">
          ...
          <li class="gongwen">
            ...
            <ul class="subnav">
              ...
              <li><a href="javascript:;" date-src="/index.php/Admin/Doc/add">公文添加</a></li>
            </ul>
          </li>
          <li class="nav-info">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>职员管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/index.php/Admin/User/showList">信息列表</a></li>
              <li><a href="javascript:;" date-src="/index.php/Admin/User/add">信息添加</a></li>
          ...
          <li class="agency">
            ...
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/index.php/Admin/Dept/getList">部门列表</a></li>
...
<script type="text/javascript">
  ...
  $.get("<?php echo U('Email/getMesCount');?>", function(data){
    //未读邮件数量的显示
    $('.msg-num').html(data);
  });
}
